...
class APIV2UpdatePostTestCase(unittest.TestCase):
    def setUp(self):
    ...
    def test_update_post_role_none(self):
        ...
        response = self.client.patch(
            ...
            data = json.dumps(
                {
                    "title": "NEW!! Uda Social Blogging API Testing",
                    "contents": "Will be finished by the end of today."
                }
            )
        )        
    ...
    def test_update_post_role_user(self):
        """  response should have status code 200 using role user
        """
        # send request:
        response = self.client.post(
            '/api/v2/posts/',
    ...
    def test_update_post_role_admin(self):
        """  response should have status code 200 using role admin
        """
        # send request:
        response = self.client.post(
            '/api/v2/posts/',
