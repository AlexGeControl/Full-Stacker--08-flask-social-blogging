...
class APIV2GetDrinksTestCase(unittest.TestCase):
    def setUp(self):
    ...
    def test_get_drinks_from_empty_db(self):
    ...
    def test_get_drinks_from_empty_table(self):
    ...
    def test_get_drinks(self):
        ...
        for drink in json_response["drinks"]:
            ...
            for ingredient in drink["recipe"]:
                ...
                self.assertTrue(not "name" in ingredient)
